...
<body>
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold">Chào mừng đến với Spring Boot JSP!</h1>
            <p class="col-md-8 fs-4">Ứng dụng đã được cấu hình thành công với Tomcat Jasper, Sitemesh 3, JPA và SQL Server.</p>
